...
class MainWindow(Tk):
    def __init__(self):
        ...
        self.label_speedup = Label(self, text="Speedup is: ")
        self.label_speedup.pack(pady=20)
    ...
    def solve_problem(self):
        ...
        self.label_speedup.config(text=f'Speedup: {time_for_default / time_for_parallel}')
